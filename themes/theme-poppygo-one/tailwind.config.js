module.exports = {
  purge: {
    enabled: false, // Set to true for production build to remove unused CSS
  ...
  theme: {
    ...
    extend: {
      ...
      // The commented-out colors block is fine as it is,
      // as you've defined colors directly above it.
      // colors: {
      //    poppycolor1: 'var(--poppy-color1)',
      //    poppycolor2: 'var(--poppy-color2)',
      //    poppycolor3: 'var(--poppy-color3)',
  ...
  variants: {
    // You might want to extend this with more variants if needed for interactive states
  },
  plugins: [
    require('@tailwindcss/typography'),
    require('@tailwindcss/aspect-ratio'), // This is the crucial line that was added
  ],
};
